...
public class VncThumbnailViewer extends Frame
    ...
    MenuItem newhostMenuItem, loadhostsMenuItem, savehostsMenuItem, exitMenuItem, playVncRecordingMenuItem, connectHostOnlyMenuItem;
    Frame soloViewer;
...
//      ((GridLayout)this.getLayout()).setColumns(thumbnailRowCount);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (evt.getSource() == playVncRecordingMenuItem) {
            RfbPlayer.open();
        }
