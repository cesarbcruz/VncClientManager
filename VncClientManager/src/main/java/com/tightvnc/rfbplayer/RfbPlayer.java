...
public class RfbPlayer extends java.applet.Applet
    ...
    public static void open() {
        ...
        java.awt.FileDialog fd = new java.awt.FileDialog(new Frame(), "Load VNC Session File...", FileDialog.LOAD);
        fd.show();
        ...
        if (file != null) {
            ...
            p.mainArgs = new String[2];
            p.mainArgs[0] = "URL";
            p.mainArgs[1] = "file:" + dir + file;
            p.inAnApplet = false;
            p.systemExit = false;
            p.inSeparateFrame = true;
